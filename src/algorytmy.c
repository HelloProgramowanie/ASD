 ...
 * 
 * @param[in] A Łańcuch liczb calkowitych
 * @param[out] B Łańcuch liczb calkowitych
...
/*********************************************************************
 * Wypelnia lancuh liczb calkowitych losowymi liczbami ze zakresu 
 * <MIN;MAX>.
 * 
 * @param[out] A Łańcuch liczb calkowitych
 * @param[in] N Długość łańcuchu
 ...
 * @param[in] R Indeks elementu końcowego
 * 
 * \return Indeks elementu łancuchu A który jest większy od każdego
 *         elementu o mniejszym indeksu, oraz mniejszy od każdego
 *         elementu o większym indeksu.
 ********************************************************************/
 ...
 *        całowitych o ograniczonej wartości 0<=A[i]<K.
 * 
 * \details Posortuje elementów łańcuchu liczb całowitych A o 
 *          ograniczonej wartości 0<=A[i]<K. 
 *
 * @param[in] A Łańcuch liczb całkowitych
 * @param[out] B Łańcuch liczb całkowitych
 * @param[in] N Długość łańcuchu
 * @param[in] K Indeks elementu końcowego
 * 
 ********************************************************************/
